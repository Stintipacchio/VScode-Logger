		...
		return new Promise(async (resolve, reject) => {
			...
			.then(response => {
				...
				// Login failed
					...
					if(!VScodeLogger.config.remember) { vscode.window.showInformationMessage('To retry the login close and re open the teardown menu'); }
					...
					await VScodeLogger.load_configs();
